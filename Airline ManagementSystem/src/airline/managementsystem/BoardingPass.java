...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        // Add table for PNR numbers
        table = new JTable();
        sp = new JScrollPane(table);
        sp.setBounds(600, 50, 300, 250);
        add(sp);
        
        displayPNRTable(); // Method to populate the PNR table
    ...
    public void displayPNRTable() {
        try {
            Conn conn = new Conn();
            String query = "select PNR from reservation";
            ResultSet rs = conn.s.executeQuery(query);
            
            // Create a model to hold table data
